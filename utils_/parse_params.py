...
def get_demo_params_from_cfg(cfg: str):
    ...
    with open(cfg) as f:
        ...
        for demo_param in demo_params:
            runtime_params, model_name, input_shape, class_names = get_model_params_from_cfg(demo_param["model_config"])
...
def get_model_params_from_cfg(cfg: str, mode: str = "runtime") -> List[Any]:
    ...
    calibration_method, calibration_data, num_calibration_data = model_params["calibration_params"].values()
    ...
    if mode == "export_onnx":
        ...
        params = [{
            ...
            "iou_thres": iou_thres,
            "anchors": anchors,
        }, model_name, input_shape, class_names
        ]
