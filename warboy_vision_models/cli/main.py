...
def face_recognition_e2e_tests(
    ...
    cfg = f"./warboy_vision_models/tests/test_config/face_recognition/{model_name}.yaml"
...
def instance_segmentation_e2e_tests(
    ...
    cfg = f"./warboy_vision_models/tests/test_config/instance_segmentation/{model_name}.yaml"
    param = get_model_params_from_cfg(cfg)
...
def object_detection_e2e_test(
    ...
    cfg = f"./warboy_vision_models/tests/test_config/object_detection/{model_name}.yaml"
    param = get_model_params_from_cfg(cfg)
...
def pose_estimation_e2e_test(
    ...
    cfg = f"./warboy_vision_models/tests/test_config/pose_estimation/{model_name}.yaml"
    param = get_model_params_from_cfg(cfg)
