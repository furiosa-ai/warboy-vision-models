...
from warboy_vision_models.warboy.utils.monitor_npu import WARBOYDevice
from warboy_vision_models.warboy.utils.process_pipeline import ImageHandler
...
def spawn_web_viewer(port: str, result_queues):
    ...
    viewer_proc = mp.Process(
        target=run_viewer,
        args=("warboy_vision_models.warboy.viewer:app",),
